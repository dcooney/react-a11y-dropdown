...
const Container = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n   position: ", ";\n   ", "\n"])), props => getProp(props.styles.position) ? props.styles.position : 'static', props => props.useStyles ? ContainerStyles : null);
...
const Menu = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n   display: ", ";\n   opacity: ", ";\n   position: ", ";\n   visibility: ", ";\n   z-index: ", ";\n   pointer-events: ", ";\n   ", "\n"])), props => getProp(props.styles.display), props => props.expanded ? '1' : '0', props => getProp(props.styles.position), props => props.expanded ? 'visible' : 'hidden', props => getProp(props.styles.zIndex), props => props.expanded ? 'auto' : 'none', props => props.useStyles ? MenuStyles : null);
/**
