...
const Menu = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n   display: ", ";\n   left: ", ";\n   opacity: ", ";\n   position: ", ";\n   top: ", ";\n   visibility: ", ";\n   z-index: ", ";\n   pointer-events: ", ";\n   ", "\n"])), props => getProp(props.styles.display), props => getProp(props.styles.left), props => props.expanded ? '1' : '0', props => getProp(props.styles.position), props => getProp(props.styles.top), props => props.expanded ? 'visible' : 'hidden', props => getProp(props.styles.zIndex), props => props.expanded ? 'auto' : 'none', props => props.useStyles ? MenuStyles : null);
/**
